...
public class FirstAdviceTest {
	...
	public void before(JoinPoint jp) {
		System.out.println("before 增强 start...");
		...
		System.out.println("before 增强 end..");
	}

	public Object around(ProceedingJoinPoint jp) throws Throwable {
		System.out.println("around 增强 start...");
		...
		System.out.println("around 增强 执行方法后...");
	...
	public void afterReturning(JoinPoint jp, Object rvt) {
		System.out.println("afterReturning 增强 获取方法的返回值:" + rvt);
	}
}
